...
export default function PublicApp() {
  ...
  return <main className="shell"><header className="topbar"><a className="brand" href="#top"><span className="brand-mark">P</span><span>CLUB PADEL</span></a><nav className="nav"><a href="#overview">Overview</a><a href="#matches">Matches</a><a href="#standings">Standings</a></nav><a className="admin-link" href="?admin=1" target="_blank" rel="noreferrer">Manage tournament ↗</a></header>
    ...
    </section><PublicStandings tournament={tournament}/><footer><span>{tournament.name} · {tournament.dates}</span><span>Scores update live</span></footer></main>;
}
